...
def sensors_thread_run_func():
    ...
    sensors_loop_thread = Thread(target=sensors_loop_thread_func(None), daemon=True)          # "None" is an arbitrary value which is required for using "GLib.timeout_source_new()".
