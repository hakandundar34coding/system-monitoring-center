...
class DiskDetails:
    ...
    def disk_details_loop_func(self):
        ...
        disk_vendor_model = Disk.disk_vendor_model_func(selected_disk, disk_type, disk_parent_name)
        ...
        self.label1305w.set_text(f'{Disk.performance_data_unit_converter_func(disk_capacity_mass_storage, performance_disk_usage_data_unit, performance_disk_usage_data_precision)}')
        self.label1306w.set_text(disk_file_system)
        self.label1307w.set_text(f'{Disk.performance_data_unit_converter_func(disk_capacity, performance_disk_usage_data_unit, performance_disk_usage_data_precision)}')
        self.label1308w.set_text(f'{Disk.performance_data_unit_converter_func(disk_available, performance_disk_usage_data_unit, performance_disk_usage_data_precision)}')
        self.label1309w.set_text(f'{Disk.performance_data_unit_converter_func(disk_used, performance_disk_usage_data_unit, performance_disk_usage_data_precision)} - {disk_usage_percent:.1f}%')
