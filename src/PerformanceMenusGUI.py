...
def performance_menus_import_func():
    ...
    global Config, PerformanceGUI, ChartPlots, Performance
    import Config, PerformanceGUI, ChartPlots, Performance
...
def performance_menus_gui_func():
    ...
    # Define builder and get all objects (Performance tab sub-tabs (CPU, RAM, Disk, Network, GPU) customizations popovers) from GUI file.
