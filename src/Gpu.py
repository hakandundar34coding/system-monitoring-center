...
class Gpu:
    ...
    def gpu_details_window_gui(self):
        ...
        self.gpu_details_window.set_default_size(400, 380)
        ...
        main_grid.attach(self.gpu_details_gpu_label, 2, 0, 1, 1)
        ...
        main_grid.attach(self.gpu_details_pcie_address_label, 2, 1, 1, 1)
        ...
        main_grid.attach(self.gpu_details_gpu_interface_label, 2, 2, 1, 1)
        ...
        main_grid.attach(self.gpu_details_link_speed_label, 2, 3, 1, 1)
        ...
        main_grid.attach(self.gpu_details_gpu_connections_label, 2, 4, 1, 1)
        ...
        main_grid.attach(self.gpu_details_refresh_rate_label, 2, 5, 1, 1)
        ...
        main_grid.attach(self.gpu_details_resolution_label, 2, 6, 1, 1)
