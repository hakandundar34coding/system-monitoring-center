...
def config_default_general_general_func():
    ...
    global remember_last_selected_hardware, selected_cpu_core, selected_disk, selected_network_card, selected_gpu
...
def config_default_performance_cpu_func():
    global chart_background_color_all_charts, chart_line_color_cpu_percent, show_cpu_usage_per_core, performance_cpu_usage_percent_precision
    chart_background_color_all_charts = [0.0, 0.0, 0.0, 0.0]
...
def config_default_performance_disk_func():
    ...
    global performance_disk_speed_data_unit, performance_disk_usage_data_unit, plot_disk_read_speed, plot_disk_write_speed
    chart_background_color_all_charts = [0.0, 0.0, 0.0, 0.0]
...
def config_default_performance_network_func():
    ...
    global performance_network_speed_data_unit, performance_network_data_data_unit, plot_network_download_speed, plot_network_upload_speed
    chart_background_color_all_charts = [0.0, 0.0, 0.0, 0.0]
...
def config_default_performance_gpu_func():
    global chart_background_color_all_charts, chart_line_color_fps, continue_fps_counting_in_background
    chart_background_color_all_charts = [0.0, 0.0, 0.0, 0.0]
...
def config_get_values_func():
    for line in config_lines:
        ...
        global chart_line_color_cpu_percent, show_cpu_usage_per_core, performance_cpu_usage_percent_precision
        ...
        global chart_line_color_fps, continue_fps_counting_in_background
